...
<ul class="rbt-sidebar-nav mt-5">
    ...
    <li><span class="text-uppercase">Forms</span>
        <ul class="list-unstyled">
            <li <?php if ($componentName == 'Clear field') { echo 'class="active"'; } ?>><a href="lib-extra-clearfield.php">Clear field</a> </li>
            <li <?php if ($componentName == 'Input groups') { echo 'class="active"'; } ?>><a href="lib-extra-inputgroup.php">Input groups</a> </li>
            <li <?php if ($componentName == 'Character count') { echo 'class="active"'; } ?>><a href="lib-extra-charactercount.php">Character count</a> </li>
            <li <?php if ($componentName == 'Inline errors') { echo 'class="active"'; } ?>><a href="lib-extra-inlineerrors.php">Inline errors</a> </li>
    ...
    <li><span class="text-uppercase">Widgets</span>
        <ul class="list-unstyled">
    ...
    <li><span class="text-uppercase">Navigation</span>
        <ul class="list-unstyled">
