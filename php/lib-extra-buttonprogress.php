...
<?php 
$section = 'extras';
$componentName = 'Button action progress';
?>
    ...
    <div class="grid-container" id="mainContent">
            ...
            <div class="demo-container">
                <div class="demo-rendered padding-3">
                    <?php include('snippets/buttonprogress.php') ?>
                </div>
                <div class="demo-code"> <small>HTML</small>
                    <button class="button small primary" data-clipboard-target="#code1">Copy</button>
                    <pre data-src="snippets/buttonprogress.php" class="language-html" id="code1"></pre>
                </div>
                <div class="demo-code"> <small>JS</small>
                    <button class="button small primary" data-clipboard-target="#code2">Copy</button>
                    <pre data-src="snippets/buttonprogress-js.php" class="language-html" id="code2"></pre>
                </div>
            </div>
        </div>
...
<?php include('snippets/buttonprogress-js.php') ?>
</body>
</html>
