...
<main>
    <div class="grid-container" id="mainContent">
        ...
        <p class="margin-bottom-3">The Rivet equvalent for this component is available <a href="https://rivet.uits.iu.edu/components/utilities/border/" target="_blank">here</a> for comparison.</p>
