    ...
    <div class="grid-container" id="mainContent">
            ...
            <div class="demo-container">
                ...
                <div class="demo-code"> <small>HTML</small>
                    ...
                    <pre data-src="snippets/iconselector.php" class="language-html" id="code1"></pre>
                </div>
                <div class="demo-code"> <small>JS</small>
                    <button class="btn btn-sm btn-primary" data-clipboard-target="#code2">Copy</button>
                    <pre data-src="snippets/iconselector-js.php" class="language-html" id="code2"></pre>
                </div>
            </div>
        </div>
...
<?php include('snippets/iconselector-js.php') ?>
</body>
</html>
