...
<main>
    <div class="grid-container" id="mainContent">
        ...
        <p class="mb-4">The Rivet equvalent for this component is available <a href="https://rivet.uits.iu.edu/components/page-content/tables/" target="_blank">here</a> for comparison.</p>
        <h2>Default table</h2>
